sudo apt install spectrwm suckless-tools thunar xfce4-terminal lightdm ligthdm-gtk-greeter lxappearance xfce4-settings materia-gtk-theme pulseaudio xsecurelock
